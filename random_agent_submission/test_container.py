...
for seed in seeds:
    ...
    # send a request to the score endpoint
    ENVIRONMENT_URL = "http://localhost:5001/"
...
print("Evaluation completed using {} seeds.".format(len(seeds)))
print("Open-loop final average score: ", np.average(scores))
...
for seed in seeds:
    ...
    # send a request to the score endpoint
    ENVIRONMENT_URL = "http://localhost:5002/"
...
print("Evaluation completed using {} seeds.".format(len(seeds)))
print("Closed-loop final average score: ", np.average(scores))
