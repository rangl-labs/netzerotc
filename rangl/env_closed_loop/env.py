...
class Parameters:
    ...
    noise_observability = True  # set to True to make the observation_space contain randomized costs/prices; set to False to restrict the observation_space to contain only the state.step_count
