...
def apply_action(action, state):
    ...
    if state.step_count == 0:
        state.generator_1_previous = 2
        state.generator_2_previous = 0
    else:    
        state.generator_1_previous = state.actions_all[state.step_count - 1][0]
        state.generator_2_previous = state.actions_all[state.step_count - 1][1]
