...
class Parameters:
    ...
    Pathways2Net0ColumnInds = np.array(
        [
            "P",
            "Q",
            "R",
...
class State:
    ...
    def initialise_state(self):
        ...
        self.EconoImpact = np.float32(
            49938.9809739566
        )  # initial economic impact of year 2030, extracted from the IEV model spreadsheet for Gale scenario
...
def apply_action(action, state):
    ...
    capex_all = np.float32(
        [
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "24"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "28"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "32"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "36"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "41"
            ),
        ]
    )
    opex_all = np.float32(
        [
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "25"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "29"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "33"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "37"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "42"
            ),
        ]
    )
    revenue_all = np.float32(
        [
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "26"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "30"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "34"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "38"
            ),
            param.Pathways2Net0.evaluate(
                "Outputs!" + param.Pathways2Net0ColumnInds[state.step_count] + "43"
            ),
        ]
    )
...
def randomise(state, action):
    ...
    MultiplicativeNoise_CCUS = np.maximum(
        0.001, np.random.randn(len(RowInds_CCUS)) * 0.1 + 1
    )
    MultiplicativeNoise_Outputs = np.maximum(
        0.001, np.random.randn(len(RowInds_Outputs)) * 0.1 + 1
    )
